...
const BigProductCard = (props: any) => {
  ...
  return (
    <>
      <Popover>
        <Popover.Button className="underline hover:text-blue-600">Produktinfo</Popover.Button>
          ...
          <div>
            <div className="flex ">
              ...
              <div className="flex flex-col justify-evenly bg-white p-2 w-full">
                ...
                <h2 className="text-center text-5xl font-extrabold">{props.price * amount}:-</h2>
